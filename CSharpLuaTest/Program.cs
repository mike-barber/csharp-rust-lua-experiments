...
namespace CSharpLuaTest
{
    ...
    public class Program
    {
        ...
        public Program()
        {
            ...
            _luaFunctionCallback = _luaStateCallback.GetFunction("Program.Factorial");
        }
        ...
        public void Run()
        {
            Console.WriteLine(MoonSharpTest());
            Console.WriteLine(NLuaTestNew());
            Console.WriteLine(NLuaTestKeep());
            Console.WriteLine(NLuaTestFunctionEval());
            Console.WriteLine(CSharpFactorial(15));
            Console.WriteLine(MoonSharpTestFunction(15));
            Console.WriteLine(NLuaTestFunctionCall(15));
            Console.WriteLine(NLuaTestFunctionCallback(15));
        }
